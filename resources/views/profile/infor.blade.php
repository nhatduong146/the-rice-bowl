...
<div class="row gutters">
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <h6 class="mb-3 text-primary" style="font-size: 20px">Thông tin cá nhân</h6>
  </div>
  @csrf
...
<div class="row gutters">
  ...
  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
    <div class="form-group">
      <label for="ciTy" style="font-size: 18px">Tên đường/Thôn</label>
      <input style="font-size: 18px; color: #fff !important;" type="name" class="form-control" id="street" placeholder="Nhập tên đường" 
                  value="{{ $user->street }}">
    </div>
  </div>
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
    <div class="form-group">
      <label for="sTate" style="font-size: 18px">Thành phố</label>
      {{-- <input type="text" class="form-control" id="sTate" placeholder="Thành phố"> --}}
      <select style="font-size: 18px; color: #fff !important; " id="province" name="provinceId" class="form-control">
        @if (isset($province))
  ...
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
    <div class="form-group">
      <label for="sTate" style="font-size: 18px">Quận/Huyện </label>
      {{-- <input type="text" class="form-control" id="sTate" placeholder="Thành phố"> --}}
      <select style="font-size: 18px; color: #fff !important; " id="district" name="provinceId" class="form-control">
        @if (isset($district))
  ...
  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
    <div class="form-group">
      <label for="sTate" style="font-size: 18px">Phường/Xã</label>
      {{-- <input type="text" class="form-control" id="sTate" placeholder="Thành phố"> --}}
      <select style="font-size: 18px; color: #fff !important; " id="village" name="provinceId" class="form-control">
        @if (isset($village))
